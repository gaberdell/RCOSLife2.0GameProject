...
public class Achievements : MonoBehaviour
{
    ...
    public Dictionary<string, Achievement> achievementTracker = new Dictionary<string, Achievement> 
    {
        ...
        {"Test Achievement1", new Achievement{category=1, name="Test Achievement", description="TBD", isObtained=true } },
        {"Test Achievement2", new Achievement{category=1, name="Test Achievement", description="TBD", isObtained=false } },
        {"Test Achievement3", new Achievement{category=1, name="Test Achievement", description="TBD", isObtained=false } },
        {"Test Achievement4", new Achievement{category=1, name="Test Achievement", description="TBD", isObtained=false } },
        {"Test Achievement5", new Achievement{category=1, name="Test Achievement", description="TBD", isObtained=false } },
        {"Test Achievement6", new Achievement{category=1, name="Test Achievement", description="TBD", isObtained=true } },
        {"Test Achievement7", new Achievement{category=1, name="Test Achievement", description="TBD", isObtained=true } },
        {"Test Achievement8", new Achievement{category=2, name="Test Achievement", description="TBD", isObtained=false } },
        {"Test Achievement9", new Achievement{category=2, name="Test Achievement", description="TBD", isObtained=true } },
        {"Test Achievement10", new Achievement{category=1, name="Test Achievement", description="TBD", isObtained=false } },
        {"Test Achievement11", new Achievement{category=1, name="Test Achievement", description="TBD", isObtained=false } },
        {"Test Achievement12", new Achievement{category=2, name="Test Achievement", description="TBD", isObtained=false } },
